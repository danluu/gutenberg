...
snapshot benchmark canary for the `20260522T150233Z` all-merged stack. The run
...
| prior documented green | `rtc-pr-stack-20260522T074557Z-all-merged-unsoundness-base-fix` | `431635f36ecfa528d139c19cf2c7a195d34d6c0a` |
| fixed | `rtc-pr-stack-20260522T150233Z-all-merged-144538-large-canary-stabilization` | `80cae0b38df6c983b4562abd9efb575d6f336bcb` |

Fixed branch URL:

```text
https://github.com/danluu/gutenberg/tree/rtc-pr-stack-20260522T150233Z-all-merged-144538-large-canary-stabilization
```

Compare against the validated base:

```text
https://github.com/danluu/gutenberg/compare/rtc-pr-stack-20260519T214027Z-tested-base...rtc-pr-stack-20260522T150233Z-all-merged-144538-large-canary-stabilization
```
...
```text
/Users/danluu/dev/fuzz/rtc-maintainer-snapshot-benchmark-gate-20260520/results/all-merged-144538-large-canary-stabilization-localdeps-harness-20260522T150233Z.noindex/results/all-merged-144538-large-canary-stabilization-localdeps-harness-20260522T150233Z
```
...
- The four benchmark-only microbenchmark files are local harness inputs copied
  ...
  `benchmark-harness-files.tsv` in the cycle directory.
...
| --- | --- | ---: | ---: |
| lower | micro-crdt | 0/2 | 9.00 |
| lower | micro-html | 0/2 | 3.50 |
| lower | micro-sync | 0/2 | 2.00 |
| multi-user | many-users-sync | 0/2 | 3.00 |
| unit-suite | crdt-stale-top-level | 0/2 | 12.00 |
| unit-suite | http-polling-manager | 0/2 | 2.50 |
| e2e | collaboration-code-editor-performance-ws | 0/2 | 6.50 |
| e2e | collaboration-sync-body-size-http | 0/2 | 16.00 |
| realistic-e2e | large-post-three-user-http | 0/2 | 31.00 |
| realistic-e2e | list-item-move-refresh-http | 0/2 | 22.50 |
| realistic-e2e | table-stale-snapshot-http | 0/2 | 25.00 |
...
| focused | revision-table-body-http | 0/1 | 16.00 |
| focused | self-presence-ui-signal-http | 0/1 | 24.00 |
...
`rtc-pr-stack-20260522T150233Z-all-merged-144538-large-canary-stabilization` at
...
`20260522T074557Z` green branch. The fresh exact-stack run passed the
