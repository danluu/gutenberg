...
| --- | --- | --- | --- |
| Active branch-link coverage | PR05A-D, PR06A-D, PR06E, PR11C-E, PR12A-C, and `HARNESS-WS-CONFIG-022004` now link to exact public `rtc-pr-stack-20260519T161502Z-*` refs; PR02A, PR11A-B, PR14B, and PR15A-C keep their exact public progress refs; older review rows keep their verified review refs | all active rows now have GitHub links and measured sizes; these links resolve the report-size bookkeeping, not semantic filing readiness | Keep future filing audits tied to these exact public refs or newer audited replacements |
