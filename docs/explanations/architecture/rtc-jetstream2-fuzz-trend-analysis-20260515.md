...
Snapshot generated: `2026-07-13T20:18:07Z`
...
The latest disk sample is `2026-07-13T20:16:48Z`: root has `42.4GiB` free and is `70.1%` used; the data volume has `252.9GiB` free and is `92.9%` used.
