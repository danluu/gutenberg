...
Snapshot generated: `2026-07-13T16:16:28Z`
...
The latest disk sample is `2026-07-13T16:15:06Z`: root has `42.5GiB` free and is `70.1%` used; the data volume has `254.6GiB` free and is `92.8%` used.
