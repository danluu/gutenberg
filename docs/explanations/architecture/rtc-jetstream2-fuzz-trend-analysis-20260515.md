...
Snapshot generated: `2026-07-12T08:02:09Z`
...
The latest disk sample is `2026-07-12T08:00:52Z`: root has `39.2GiB` free and is `72.3%` used; the data volume has `268.4GiB` free and is `92.4%` used.
