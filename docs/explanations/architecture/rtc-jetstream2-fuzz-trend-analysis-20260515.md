...
Snapshot generated: `2026-07-11T15:54:06Z`
...
The latest disk sample is `2026-07-11T15:52:52Z`: root has `36.7GiB` free and is `74.1%` used; the data volume has `275.4GiB` free and is `92.2%` used.
