...
Snapshot generated: `2026-07-13T04:11:27Z`
...
The latest disk sample is `2026-07-13T04:10:07Z`: root has `42.5GiB` free and is `70.0%` used; the data volume has `259.8GiB` free and is `92.7%` used.
