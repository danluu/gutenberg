...
Snapshot generated: `2026-07-11T07:50:51Z`
...
The latest disk sample is `2026-07-11T07:49:41Z`: root has `36.7GiB` free and is `74.1%` used; the data volume has `280.7GiB` free and is `92.1%` used.
