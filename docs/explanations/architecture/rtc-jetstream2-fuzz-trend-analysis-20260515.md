...
Snapshot generated: `2026-07-12T16:05:23Z`
...
The latest disk sample is `2026-07-12T16:04:10Z`: root has `39.2GiB` free and is `72.3%` used; the data volume has `264.9GiB` free and is `92.5%` used.
