...
Snapshot generated: `2026-07-12T20:07:23Z`
...
The latest disk sample is `2026-07-12T20:05:49Z`: root has `39.2GiB` free and is `72.4%` used; the data volume has `263.2GiB` free and is `92.6%` used.
