 ...
 * @typedef {{ awareness: Map<string, unknown>, clients: Set<TestSocket>, doc: Y.Doc, updates: string[] }} Room
 * @typedef {{ type?: string, room?: string, clientId?: string | number, state?: string, stateVector?: string, awareness?: unknown, update?: string }} TestMessage
 */
...
/**
 * @return {string} Empty Yjs update encoded as base64.
 */
