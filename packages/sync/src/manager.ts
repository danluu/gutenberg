...
export function createSyncManager( debug = false ): SyncManager {
	 ...
	 * @param {ObjectData}               options.baseRecord         Base record used to suppress stale same-key local echoes.
	 * @param {boolean}                  options.isSave             Whether this update represents a user-facing entity save. Defaults to false.
