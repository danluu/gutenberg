...
describe( 'crdt-blocks', () => {
	...
	describe( 'mergeCrdtBlocks', () => {
		...
		it( 'observes attribute edits when the editor reuses the same block array reference', () => {
			const blocks = [
				{
					name: 'core/paragraph',
					attributes: { content: 'Initial content' },
			...
			blocks[ 0 ] = {
				...blocks[ 0 ],
				attributes: { content: 'Edited through reused array' },
			};
			mergeCrdtBlocks( yblocks, blocks, null );
			...
			).toEqual( [ 'Edited through reused array' ] );
		} );
